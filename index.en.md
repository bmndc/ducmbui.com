...
You can view or print my <abbr title="curriculum vitae">CV</abbr> [here]({% link cv.md %}), and get in touch by sending me an e-mail at _duc (at) ducmbui.com_.
...
- Get ready for the capstone courses as a final-year student
	- I'm open to work! See the section above for my CV and contact information.
- Learn some skills on LinkedIn Learning and use up my student benefits
- Build my cybersecurity profile with [Hack the Box](https://hackthebox.com) and [TryHackMe](https://tryhackme.com)
- Set up and self-host services on my own domain
- Think about this website a bit too much
- Perhaps more outdoor physical exercises

On the shelf:

- Revise documentation on [the BananaHackers website](https://bananahackers.net) and maintain the [BananaHackers Store](https://store.bananahackers.net)
- Develop a [revival fork of Mammoth](https://git.sr.ht/~ducmbui/mammoth), a Mastodon client for Apple devices
- Build a web client for Lemmy that mimics 2018 Reddit UI design, using React and TypeScript

Contributing to open-source projects: _unfortunately none at the moment!_
...
In [Vietnamese naming customs](https://en.wikipedia.org/wiki/Vietnamese_name), the surname is positioned before the given name*, and people are referred to by their first names. My full name with Vietnamese diacritics is **Bùi Minh Đức**, thus I am called Duc, not Bui.

Phonetic breakdown of my first name:

- the Đ sounds like the standard English D sound;
- the ư is an unrounded vowel, spoken with a slight smile and spreaded lips;
- the c is unreleased and sounds like it ends in a sharp stop; you prepare to make a _k_ sound but don't actually puff air out.

For English speakers, Đức rhymes with "book" or "look" but with _d_ as the first letter (_dook_). To mimic the rising tone, say as if you're asking a quick question (_dook?_).

I'm okay with variations of my name such as _duck_ or _zook_, however.
...
- [Mastodon](https://toot.community/@duc) (bridged to [Bluesky](https://bsky.app/profile/did:plc:dahvph3xzocj4eeddlevdtv7) via fed.brid.gy)
...
- [Reddit](https://www.reddit.com/user/biminhc1) ([alternative account](https://www.reddit.com/user/ducmbui))
